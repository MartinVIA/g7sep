 ...
 * creating new trades.
 * The view lets the user enter trade details and select
 * a resident who requests the trade.
 *
 * @author Loke Hansen
 * @version 1.0
 */
public class TradeViewController {
  ...
  /**
   * Creates and returns the JavaFX scene used to create
   * a new trade.
   *
  ...
  /**
   * Handles creation of a new trade using the entered values.
   * The method validates the input fields and selected resident
   * before adding the trade through the model.
   */
