...
public class StartGUI extends Application {
    ...
    private VBox communityPointsBox;
    ...
    private void refreshTasksAndProgress() {
        refreshTasksTable();
        if (progressBar != null && communityPointsBox != null) {
            progressBar.setProgress((double) model.getGreenPoints() / model.getGreenPointsGoal());
            communityPointsBox.getChildren().set(1, new Label("Progress toward next green reward: " + model.getGreenPoints() + "/" + model.getGreenPointsGoal() + " green points"));
        }
    }
    ...
    public void start(Stage primaryStage) {
        ...
        Button community_points_add = new Button("Add Green Points");
        ...
        task_edit.setOnAction(e -> {
            ...
            ManageTaskController controller = new ManageTaskController(
                    model, selected, this::refreshTasksAndProgress);
        ...
        communityPointsBox.getChildren().add(new Label("Progress toward next green reward: " + model.getGreenPoints() + "/" + model.getGreenPointsGoal() + " green points"));
        progressBar.setProgress((double) model.getGreenPoints() / model.getGreenPointsGoal());
