...
/**
 * Controller responsible for creating a view that displays tasks
 * and allows the user to add new tasks.
 * The controller shows a list of existing tasks and provides input
 * fields for task name, description, type, and points.
 *
 * @author Victor Țonu
 * @version 1.0
 */
public class TaskViewController {
  ...
  /**
   * Creates and returns the main layout for the task view.
   * The layout contains a task list and controls for adding new tasks.
   *
  ...
  /**
   * Handles adding a new task using the entered values.
   * The method validates that a name and type are provided and that
   * points are a valid whole number if entered, then adds the task
