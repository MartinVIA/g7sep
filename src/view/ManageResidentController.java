 ...
 * managing a specific resident.
 * The controller provides options for changing the resident’s
 * name, editing points, managing boost status, and removing
 * the resident.
 *
 * @author Loke Hansen
 * @version 1.0
...
public class ManageResidentController {
  ...
  /**
   * Constructs a ManageResidentController with the given
   * model and resident.
   *
  ...
  public Scene createScene() {
    ...
    VBox root = new VBox(10, title, changeNameBtn, editPointsBtn, addBoostBtn,
        removeBoostBtn, removeResidentBtn, closeBtn);
