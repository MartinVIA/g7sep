...
/**
 * Controller responsible for creating the main resident view.
 * The view displays a list of residents and provides functionality
 * for adding new residents and awarding personal points to a
 * selected resident.
 *
 * @author Loke Hansen
 * @version 1.0
...
public class ResidentViewController {
  ...
  /**
   * Creates and returns the JavaFX scene showing the resident list
   * and controls for adding residents and awarding points.
   *
  ...
  /**
   * Refreshes the resident list view by reloading residents
   * from the model.
   */
  ...
  /**
   * Handles adding a new resident using the entered first and last name.
   * The method validates that the name fields are not empty,
   * adds the resident through the model, and refreshes the list.
   */
  ...
  /**
   * Handles awarding points to the currently selected resident.
   * The method validates that a resident is selected and that the
   * entered points value is a valid whole number before updating
   * the model and refreshing the list.
   */
