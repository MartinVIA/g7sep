...
public class StartGUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            System.out.println("Loading data from JSON files (AI test)...");
            List<Resident> residentsFromJSON = JSONReader
                    .readResidentsFromJSON("AItest_file_operations_residents.json");
            Map<Integer, Integer> pointsFromJSON = JSONReader
                    .readPersonalPointsFromJSON("AItest_file_operations_personalpoints.json");
